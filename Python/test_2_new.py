...
passive_forces = np.load("/home/fenics/shared/test_2_new/passive_forces.npy")
...
for l in range(time_steps):
    ...
    p_f_array = np.ones(24) * passive_forces[l,0] 
    ...
    y_vec.vector()[:] = y_vec_array_new # for PDE  
...
np.save("/home/fenics/shared/test_2_new/rates",rate_constants)

np.save("/home/fenics/shared/test_2_new/dumped_populations",dumped_populations)

np.save("/home/fenics/shared/test_2_new/tarray",tarray)

np.save("/home/fenics/shared/test_2_new/stress_array",strarray)

np.save("/home/fenics/shared/test_2_new/pstress_array",pstrarray)

np.save("/home/fenics/shared/test_2_new/calcium",calarray)

np.save("/home/fenics/shared/test_2_new/displacements",darray)

np.save("/home/fenics/shared/test_2_new/HSL",hslarray)

np.save("/home/fenics/shared/test_2_new/DHSL",delta_hsls)

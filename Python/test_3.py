# -*- coding: utf-8 -*-
"""
Created on Mon Oct  8 11:01:41 2018
...
end_time = step_size*time_steps

dumped_populations = np.zeros((time_steps, no_of_int_points, n_array_length))

passive_forces = np.load("/home/fenics/shared/test_3/passive_forces.npy")
hsl_myosim = np.load("/home/fenics/shared/test_3/hsl_myosim.npy")
...
for i in range(time_steps):
    ...
    p_f = np.ones(np.shape(hsl)) * passive_forces[i] 
    ...
    stress.vector()[:] = Myosim.Get_cb_force_vec()  # scaling down cb_force just bc dimensions don't match in fenics and myosim instr file
    
    cb_f = stress.vector()[:].get_local() # or cb_f = = Myosim.Get_cb_force_vec()
    ...
    hsl = np.ones(np.shape(hsl)) * hsl_myosim[i]
...
np.save("/home/fenics/shared/test_3/rates",rate_constants)
np.save("/home/fenics/shared/test_3/dumped_populations",dumped_populations)
np.save("/home/fenics/shared/test_3/tarray",tarray)
np.save("/home/fenics/shared/test_3/stress_array",stress_array)
np.save("/home/fenics/shared/test_3/calcium",calcium)
np.save("/home/fenics/shared/test_3/HSL",HSL)

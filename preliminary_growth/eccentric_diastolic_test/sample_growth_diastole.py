...
# @Last modified time: 2022-01-06T13:03:08-05:00
...
# save reference mesh and initiate files
...
functions = diastolic_filling.diastolic_filling(fcn_spaces, functions, uflforms, Ftotal, Jac, bcs, 0.25, 0, total_sol_file, p_f_file)
...
while np.average(functions["deviation"].vector().get_local()) > tol:
    ...
    # Load to ED
    functions = diastolic_filling.diastolic_filling(fcn_spaces, functions, uflforms, Ftotal, Jac, bcs, 0.25, growth_iter_counter, total_sol_file, p_f_file)

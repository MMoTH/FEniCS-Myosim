...
endofilename = 'r100815_endo' + '.stl'
endopdata = vtk_py.readSTL(endofilename)

epifilename = 'r100815_epi' + '.stl'
...
vtk_py.createLVmesh(filename, 0.25, "clipped_epi_tmp.stl", "clipped_endo_tmp.stl")#(filename, 0.45, "clipped_epi_tmp.stl", "clipped_endo_tmp.stl") #

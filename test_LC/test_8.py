import sys
sys.path.append('/home/fenics/shared/Research/FEniCS-Myosim')
...
Pactive = 50 * cb_force * as_tensor(f0[i]*f0[j], (i,j))
...
ext_module = compile_extension_module(code=code, source_directory="/home/fenics/shared/Research/FEniCS-Myosim/C++", sources=["hs.cpp", "mf.cpp", "Ca.cpp", "base_parameters.cpp"],
     additional_system_headers=["petscvec.h"],
     include_dirs=[".", os.path.abspath("C++"),"/usr/include", "/home/fenics/shared/Research/FEniCS-Myosim/C++"],
...
# Closed loop cycle
# circ parameters
Cao = 0.005/1000.0; #5.0e-5; #Cao = 0.005;
Cven = 0.2*10/1000.0 #0.02;#Cven = 0.2*10;
Vart0 = 380.0/1000.0#/2000;
Vven0 = 0.001*2200.0/1000.0#/2000;
Rao = 10*1000.0*1000.0#1.0e9; #Rao = 10*1000.0;
Rven = 1000*1000.0#1.0e8; #Rven = 1000.0;
Rper = 150000*1000.0#1000.0;
V_ven = 2.5*5000.0/1000.0#/2000; 
V_art = 450.0/1000.0#/2000;
...
while(cycle < cycles):
    ...
    cell_counter = int(cell_time /BCL * 100)

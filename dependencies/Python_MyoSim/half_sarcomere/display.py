...
def display_fluxes(data_structure, output_file_string="", t_limits=[], \
    ...
    if (kinetic_scheme=='3state_with_SRX'):
        ...
        ax1.plot('hs_time', 'J1', data=data_structure, label='J1')
        ax1.plot('hs_time', 'J2', data=data_structure, label='J2')
        ...
        ax2.plot('hs_time', 'J3', data=data_structure, label='J3')
        ax2.plot('hs_time', 'J4', data=data_structure, label='J4')
        ...
        ax3.plot('hs_time', 'Jon', data=data_structure, label='Jon')
        ax3.plot('hs_time', 'Joff', data=data_structure, label='Joff')
